...
/*   Updated: 2023/10/25 11:59:02 by albaud           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	inp = v_new(ag->ann.info.inputs, 0);
// 	res.head = 0;
// 	res.size = 0;
// 	m = 0;
// 	i = i * 5 + 10;
...
// 	while (++j < MOVES_AMOUNT)
// 	{
// 		ann_forward(&g->ann, moves[j]->input);
// 		ann_backward(&g->ann, moves[j]->input, moves[j]->output);
// 	}
// }
...
// 		// ann_save(&agent->ann, SAVE_INT, population[0].score);
// 		j = -1;
// 		while (++j < POPSIZE)
